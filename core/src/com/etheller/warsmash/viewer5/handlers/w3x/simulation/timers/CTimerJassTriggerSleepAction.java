...
public class CTimerJassTriggerSleepAction extends CTimer implements CHandle {
	...
	public CTimerJassTriggerSleepAction(final GlobalScope jassGlobalScope, final int handleId) {
